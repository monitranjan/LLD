...
public class HasMoneyState implements State{
    ...
    public void chooseProduct(VendingMachine machine, int codeNumber) throws Exception {
        throw new Exception("first you need to click on start product selection button first");
    }
    ...
    public List<Coin> refundFullMoney(VendingMachine machine) throws Exception {
        System.out.println("Returned the full amount back in coin dispense");
    ...
    public void updateInventory(VendingMachine machine, Item item, int codeNumber) throws Exception {
        throw new Exception("you can't update inventory in hasMoney state");
    }
}
